...
- /cc deaf (on|off) (hide chat messages, defaults to on)
- /cc drunk (on|off) (screen effect overlay, defaults to on)
- /cc bound (on|off) (disable move controls, defaults to on)
- /cc follow target (force follow, defaults to <t>)
